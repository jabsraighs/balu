 ...
 */
final class Version20240502081757 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , user_client_id BLOB DEFAULT NULL --(DC2Type:uuid)
        , entreprise_id BLOB DEFAULT NULL --(DC2Type:uuid)
        , firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_C7440455190BE4C5 FOREIGN KEY (user_client_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C7440455A4AEAFEA FOREIGN KEY (entreprise_id) REFERENCES entreprise (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE entreprise (id BLOB NOT NULL --(DC2Type:uuid)
        , user_entreprise_id BLOB NOT NULL --(DC2Type:uuid)
        ...
        , PRIMARY KEY(id), CONSTRAINT FK_D19FA604A2002BA FOREIGN KEY (user_entreprise_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_90651744A4AEAFEA ON invoice (entreprise_id)');
        ...
        , PRIMARY KEY(id), CONSTRAINT FK_8D93D649A4AEAFEA FOREIGN KEY (entreprise_id) REFERENCES entreprise (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
