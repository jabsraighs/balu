 ...
 */
final class Version20231216224532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE invoice (id INT NOT NULL, quote_id INT NOT NULL, created_date DATE NOT NULL, due_date DATE NOT NULL, payment_status VARCHAR(50) NOT NULL, total_amount DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_90651744DB805178 ON invoice (quote_id)');
        $this->addSql('COMMENT ON COLUMN invoice.created_date IS \'(DC2Type:date_immutable)\'');
        $this->addSql('COMMENT ON COLUMN invoice.due_date IS \'(DC2Type:date_immutable)\'');
        $this->addSql('CREATE TABLE payment (id INT NOT NULL, invoice_id INT NOT NULL, amount_paid DOUBLE PRECISION NOT NULL, payment_date DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE quote (id INT NOT NULL, client_id INT DEFAULT NULL, created_date DATE NOT NULL, expiry_date DATE NOT NULL, status VARCHAR(50) NOT NULL, total_amount DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6B71CBF419EB6921 ON quote (client_id)');
        $this->addSql('COMMENT ON COLUMN quote.created_date IS \'(DC2Type:date_immutable)\'');
        $this->addSql('COMMENT ON COLUMN quote.expiry_date IS \'(DC2Type:date_immutable)\'');
        $this->addSql('CREATE TABLE quote_line (id INT NOT NULL, quote_id INT NOT NULL, quantity INT NOT NULL, unit_price DOUBLE PRECISION NOT NULL, subtotal DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_43F3EB7CDB805178 ON quote_line (quote_id)');
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_verified BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
